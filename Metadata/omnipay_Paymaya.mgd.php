...
return [
  [
    ...
    'metadata' => [
      ...
      'payment_fields' => ['credit_card_type', 'credit_card_number', 'credit_card_exp_date', 'cvv2', 'payment_token'],
      'regions' => [
        //'billing-block-post' => [],
        'billing-block' => [
          [
            'name' => 'paymaya_script',
            'weight' => 500,
            'script' => file_get_contents(__DIR__ . '/js/omnipay_Paymaya.js'),
          ],
        ],
      ],
      'fields' => [
    ...
    'params' => [
      'version' => 3,
      'title' => 'OmniPay - Paymaya (not confirmed as working)',
      'name' => 'omnipay_Paymaya',
      'description' => 'Omnipay Paymaya',
